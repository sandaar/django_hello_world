...
COMMIT_ID="da418bc095a332b72cc4f124f8f7fabd06dea8c3"
...
#aws deploy create-deployment-group --application-name $APPLICATION_NAME --auto-scaling-groups StagingApps --deployment-group-name $DEPLOYMENT_GROUP_NAME --service-role-arn $SERVICE_ROLE_ARN 
